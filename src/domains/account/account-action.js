...
export const AccountAction = memo(function AccountAction({
  ...
  return (
    <div className="flex items-center gap-2">
      <Button
        ...
        className="flex items-center gap-2 rounded-xl bg-info/15 px-3 py-1.5 text-xs font-semibold text-info hover:bg-info hover:text-black transition-colors"
        onClick={(event) => {
