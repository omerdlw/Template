  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5">
        ...
        {message ? <p className="text-xs text-white/45">{message}</p> : null}
      </div>
    </SectionCard>
  );
}
    ...
    >
      <div className="flex flex-col gap-2.5">
        {sessions.length ? (
          ...
          <p className="text-sm text-white/45">No active session data.</p>
        )}
      </div>
    ...
    >
      <div className="flex flex-col gap-2.5">
        {passkeys.length ? (
          ...
          <p className="text-sm text-white/45">No passkeys registered.</p>
        )}
      </div>
      <SurfaceAction
