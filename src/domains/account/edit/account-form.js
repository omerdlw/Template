    ...
    >
      ...
      >
        <div className="overflow-hidden rounded-[20px] bg-white/5 ring-1 ring-inset ring-white/5">
          <div className="relative aspect-[3/1] bg-black/20">
            {preview(
              form.bannerUrl,
              "Banner preview",
            ...
            {!form.bannerUrl ? (
              <span className="center absolute inset-0 text-xs text-white/50">
                No banner image
              </span>
            ) : null}
          </div>
        ...
        <div className="grid gap-2.5 sm:grid-cols-[minmax(0,1fr)_minmax(0,2fr)]">
          <div className="center min-h-40 overflow-hidden rounded-[20px] bg-white/5 ring-1 ring-inset ring-white/5">
            ...
            {!form.avatarUrl ? (
              <span className="text-xs text-white/50">No avatar image</span>
            ) : null}
          </div>
